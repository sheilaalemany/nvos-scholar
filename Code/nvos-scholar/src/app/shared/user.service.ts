...
export class UserService {
  ...
  rating(rating: object) {
    return this.http.post(environment.apiBaseUrl + "/rating", rating);
  }

  getRating(article : object) {
    return this.http.post(environment.apiBaseUrl + "/getRating", article);
  }
  //Saves feedback history to DB
  addFeedback( feedbackInfo : object){
    return this.http.post(environment.apiBaseUrl + "/savefeedback", feedbackInfo);
  }

//save feedback entry
  saveEntries( entry : object){
    return this.http.post(environment.apiBaseUrl + "/saveEntries", entry);
  }
