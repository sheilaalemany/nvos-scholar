...
export class DisplayresultsComponent implements OnInit {
 ...
 //Opens Save popup
  ...
  //====rating up=======//
  addup(title : String, authors: Array<String>, year: String, abstract: String) {
    ...
    if (this.userService.isLoggedIn()){
      ...
      var user = this.userDetails.email;
    } else{ user = "anonymous";}

    var query1: string = window.location.search.substring(1).split("=")[1];
    var search: string = query1.replace(/%20/gi, " ");
    // feedback entry
    var entry =  {
      title: title,
      search_query: search,
    ...
    this.userService.saveEntries(entry).subscribe();
//=============================================
    if (this.userService.isLoggedIn()){
    var rate =1;
    var feedbackInfo =  {
      feedback:{ title, authors,year,abstract, rate}
    };


    /*saves feedback history to users profile*/
  this.userService.getUserProfile().subscribe(
  res => {
    this.userDetails = res["user"];
    this.userService.addFeedback(feedbackInfo).subscribe();
    // alert('The article was successfully saved to users page')
    if(document.getElementById(title+'-imagedown').innerHTML == '<img src="../../../assets/img/down-arrow-red.png" alt="up arrow icon" style="width:35px;height:35px;border:0;margin-bottom:15px;">') {
      document.getElementById(title+'-imagedown').innerHTML = '<img src="../../../assets/img/down-arrow-gray.png" alt="up arrow icon" style="width:35px;height:35px;border:0;margin-bottom:15px;">';
    }
    document.getElementById(title+'-imageup').innerHTML = '<img src="../../../assets/img/up-arrow-green.png" alt="up arrow icon" style="width:35px;height:35px;border:0;margin-bottom:15px;">';
...
/*saves feedback and keeps total rating for an article. Increases rating*/
    this.userService.getRating(article).subscribe(
      res => {
        this.feedBackDetails = res["articlefeedback"];
         this.feedBackDetails;
        console.log(this.feedBackDetails.rating);
        var currentRating = this.feedBackDetails.rating;
        const rating1 = {
          rating: currentRating + 1,
          title: title
      };
        this.userService.rating(rating1).subscribe();
        // alert('The rating was successfully updated!')
        if(document.getElementById(title+'-imagedown').innerHTML == '<img src="../../../assets/img/down-arrow-red.png" alt="up arrow icon" style="width:35px;height:35px;border:0;margin-bottom:15px;">') {
          document.getElementById(title+'-imagedown').innerHTML = '<img src="../../../assets/img/down-arrow-gray.png" alt="up arrow icon" style="width:35px;height:35px;border:0;margin-bottom:15px;">';
        }
        document.getElementById(title+'-imageup').innerHTML = '<img src="../../../assets/img/up-arrow-green.png" alt="up arrow icon" style="width:35px;height:35px;border:0;margin-bottom:15px;">';
  ...
  //====rating down=======//
  substract(title : String, authors: Array<String>, year: String, abstract: String) {
    //var article = title;
    var article =  {
      title: title
    };
    /*console.log(title);
    //var rating = this.feedBackDetails.rating;
*/
...
var rate = -1;
  ...
  res => {
    ...
    this.userService.addFeedback(feedbackInfo).subscribe();
    // alert('The rating was successfully updated!')
    if(document.getElementById(title+'-imageup').innerHTML == '<img src="../../../assets/img/up-arrow-green.png" alt="up arrow icon" style="width:35px;height:35px;border:0;margin-bottom:15px;">') {
      document.getElementById(title+'-imageup').innerHTML = '<img src="../../../assets/img/up-arrow-gray.png" alt="up arrow icon" style="width:35px;height:35px;border:0;margin-bottom:15px;">';
    }
    document.getElementById(title+'-imagedown').innerHTML = '<img src="../../../assets/img/down-arrow-red.png" alt="up arrow icon" style="width:35px;height:35px;border:0;margin-bottom:15px;">';

  },
  err => {}
);
}
/*saves feedback and keeps total rating for an article. Decreases rating*/
    this.userService.getRating(article).subscribe(
      res => {
        this.feedBackDetails = res["articlefeedback"];
         this.feedBackDetails;
