...
function createConceptWidget(){
		...
		var autocomplete = $('#owlauto').owl_autocomplete({focus : true, chars : 2, filter : 'Class'}); //Tab 1 search
...
// 	$('#Axiomwidget').show();
// 	return $('#Axiomwidget .resourcebox').owl_propertyLens({"sparql-dl:PropertyValue(owl:Axiom, ?p, ?t)" : {sort: "?p"}});
// }
