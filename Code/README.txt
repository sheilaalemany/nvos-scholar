...
The ontology visualization page was not created using Angular, but rather jQuery and D3. The tree visualization is found in the treeview folder in the src folder. The node graph visualization is found in the graphview folder in the src folder.
